---
layout: post
title:  Some advice I have for people trying to do well on the CCC
date:   2021-06-19
...
# introduction
The CCC has a special place in my heart as I've devoted a lot of time to it - I'll always remember being woken up by a barrage of notifications from people DMing me that I qualified for stage 2. Through prep I've been able to meet a community of amazing students, learned many skills and overall had an immensely rewarding experience. But, figuring out how to prepare for this contest can be quite hard for newcomers. The official website is basically useless and if you have no friends to guide you, you're on your own. This blog post is an attempt to help remedy that a little - I'll be talking about some tips for the CCC as well as other tidbits I've picked up from my time in competitive programming. This post is mainly targeted towards Canadian middle/high school students. Good luck and have fun!

# about the contest

The [CCC](https://cemc.uwaterloo.ca/contests/computing.html) is the most prominent competitive programming contest for Canadian high schoolers, held by the University of Waterloo. Competitors are given 3 hours to solve 5 coding problems. In these problems, input and output are specified, and the object is to write a program that takes in input, does some computation, and produces the answer.  These problems rely on concepts like designing efficient algorithms and ad-hoc thinking. An example of a problem could be to find the [modular inverse of a number](https://dmoj.ca/problem/ccc01j2). Performance on the CCC is taken into consideration for admissions to certain Waterloo programs including math, computer science, and software engineering. In addition, prepping for the CCC might help later on with algorithms courses or tech interviews.
...
Through outstanding performance you can earn a spot on the Honour roll (top 3-ish%) which is sorted by Group 1, 2, 3, etc from highest to lowest score. You could also be invited to the Canadian Computing Olympiad which is a week-long camp with two contest days (usually top 25ish).
...
Atcoder also has really good thinking problems with extremely well written statements. I find that these problems tend to be more mathy, which you may or may not like. Atcoder runs weekly rated contests, but it can be hard to wake up for them as they are in the morning on weekends. If you choose to use Atcoder [this](https://kenkoooo.com/atcoder/#/table/) is a useful resource to help you pick problems of the appropriate difficulty.
...
To be completely honest, the most important takeaway is to just **do a lot of problems**.

#### picking problems at random

A question I've gotten is what problems are the best to practice on. Everyone trains differently and what works for one person might not work for another. I'd suggest picking random problems around the level you start failing to be able to solve independently. Picking problems at random forces you to think about every problem with no info, whereas other approaches like picking by topic might spoil some parts of the solution. Another benefit of randomly picking problems is that you practice an even spread of topics like graphs, dynamic programming, data structures, etc. Personally, I went to Codeforces's problemset and started from problems rated 1600, and slowly worked my way up to 1900. 

If you get stuck, you can read editorials or ask someone for help. However, one thing I wish I didn't do was reading solutions too fast - try to not read solutions unless you are really stuck and have no leads. 
...
If we look at the last 2 years of the CCC, we can notice that the complexity of techniques or "knowledge" needed to qualify for the CCO is actually quite small. Rather, what makes or breaks your performance is being able to apply basic concepts in creative ways.
...
One good habit after doing a contest is to do the easiest problem(s) you got stuck on, reading solutions if you need to (known as upsolving). Some good contests that I haven't already mentioned include [USACO](http://www.usaco.org/), Google [Kickstart](https://codingcompetitions.withgoogle.com/kickstart)/[Code Jam](https://codingcompetitions.withgoogle.com/codejam), [Facebook Hacker Cup](https://www.facebook.com/codingcompetitions/hacker-cup), [COCI](https://hsin.hr/coci/), and [ECOO](https://ecoocs.org/).

# "how good do I need to be to make xyz? / what should I know? / how much did you practice?"

This is kind of a difficult question to answer, mostly because it's kind of scary to make bold claims along the lines of "if you know this, this and this you _will_ qualify for honour roll". Also, it's really hard to quantitatively measure competitive programming skill. Personally, at the time of writing CCC 2021 (late February) my Codeforces rating fluctuated between 1600-1800, though there were people with lower rating that did better than me and those with higher rating that did worse. I began seriously training in around March 2020, when Ontario schools closed due to the pandemic. Prior to that, I had done a bit of competitive programming casually and placed in the CCC honour roll in 2020. Many people are able to achieve a great score in less than a year, so don't sweat it if you don't have much experience.

If you're interested, here's some unofficial spreadsheets of some people who chose to disclose their score, and you can look through their profiles to try to get a sense of how good they were. 
...
If you flop (which is a very real possibility) try not to get too depressed! In my experience, if you didn't perform on the day of it can feel like all the time you spent preparing was useless, but even without a good performance you gain so much from even trying. There are many people who get into Waterloo/other good unis with a bad CCC score, and likewise there are top scorers that get rejected/deferred. A strategy that helped me gain a healthier outlook on contests was remembering that in the long run contests don't really matter all that much. 

Though everyone's situation is different, you should consider that it might not be worthwhile to sacrifice things like grades, extracurriculars or relationships for competitive programming.

_"Once you find programming is no fun anymore – drop it. Play soccer, find a girlfriend, study something not related to programming, just live a life – programming contests are only programming contests, and nothing more. Don’t let them become your life – for your life is much more interesting and colorful."_ - Petr Mitrichev

#### lessons?

Something to consider is taking additional lessons at third-party schools e.g. [Olympiads School](https://olympiads.ca/). These programs basically consist of weekly homework/problem takeup, with occasional contests sprinkled in. My personal opinion is that these are essentially (pretty pricy) editorial services, and you can forgo them but they don't hurt. I started going to Olympiads around 1-2 months before CCC 2021, but I think I still would have qualified for the CCO without Olympiads. Some aspects that might be helpful are motivation, making friends, and being guided by someone who knows how contests work. Most CCO qualifiers go to Olympiads School, though correlation != causation :p
...
- Making "baby steps" e.g. working through sample, guessing properties, solving subproblems rather than just staring at the problem
- Using the entire allotted time instead of giving up near the end
...
- Sleep is very important! One way to sleep better is to exercise the day before so you get tired
- Don't bring a loud keyboard or people will get mad at you
